<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EditBrand.aspx.cs" Inherits="EditBrand" EnableEventValidation="false" %>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <asp:Button ID="UpdateBrand" CssClass="btn btn-primary " runat="server" Text="UPDATE" OnClick="UpdateBrand_Click" />
                        </div>
                    </div>
                </div>
            </div>
